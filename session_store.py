...
def _load_scenarios_from_file(default_scenarios: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    path = os.environ.get("SCENARIOS_PATH")
    if not path:
...
SCENARIOS = _load_scenarios_from_file(DEFAULT_SCENARIOS)
